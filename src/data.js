...
var PostDetails = /** @class */ (function () {
    function PostDetails(id, postId, email, body) {
        this.id = id;
        this.postId = postId;
        this.email = email;
        this.body = body;
...
var commentsPosts = [
    new PostDetails(1, 1, 'sarah.williams@example.com: ', 'Artificial Intelligence has truly revolutionized the way businesses operate in the digital age.'),
    ...
    new PostDetails(2, 2, 'john.doe@example.com: ', 'Data privacy has become a paramount concern in todays digital landscape. With the ever-increasing amount of personal information being collected and shared online, its crucial to address the challenges associated with protecting sensitive data.'),
    new PostDetails(2, 2, 'emily.smith@example.com: ', 'In this age of constant data breaches and privacy concerns, finding effective solutions for data privacy is imperative.'),
    ...
    new PostDetails(3, 3, 'sophia.johnson@example.com: ', 'Social media has undeniably transformed our society, both positively and negatively. On one hand, it has revolutionized communication, connecting people from all corners of the world and allowing for the sharing of ideas and experiences.'),
    ...
    new PostDetails(4, 4, 'william.thomas@example.com: ', 'Blockchain technology is reshaping the way we establish trust in the digital realm. By providing a decentralized and immutable ledger, blockchain enables secure and transparent transactions without the need for intermediaries.'),
    new PostDetails(4, 4, 'lily.moore@example.com: ', 'The advent of blockchain technology has ushered in a new era of digital trust. With its decentralized and tamper-proof nature, blockchain enables secure peer-to-peer transactions, verifiable data records, and smart contracts.'),
    ...
    new PostDetails(5, 5, 'james.miller@example.com: ', 'Renewable energy technologies hold the key to a sustainable future. As we face the challenges of climate change and environmental degradation, transitioning to renewable sources like solar, wind, and hydropower is crucial.'),
    ...
    new PostDetails(6, 6, 'olivia.davis@example.com: ', 'In the 21st century, technology has become an integral part of education, opening up new possibilities for teaching and learning. Digital devices, educational apps, and online platforms have made education more accessible, flexible, and engaging.'),
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function getPostDetailsId(postId) {
        return commentsPosts.filter(function (comment) { return comment.postId === postId; });
    }
    ...
    function setDetails(postId) {
        ...
        postDetails.forEach(function (comment, index) {
            ...
            emailSpanElement.textContent = "user_ ".concat(index + 1, ": ").concat(comment.email);
